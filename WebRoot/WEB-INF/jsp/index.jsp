            ...
            <ul class="layui-nav layui-nav-tree"  lay-shrink="all" id="lm">
               <li class="layui-nav-item">
			     <a href="javascript:;" id="1"><i class="layui-icon layui-icon-app"></i>&nbsp;我的工具</a>
			      <dl class="layui-nav-child">
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(1,'/OA/page_clock','我的日历')">&nbsp;&nbsp;&nbsp;&nbsp;我的日历</a></dd>
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(2,'/OA/page_weather','天气查询')">&nbsp;&nbsp;&nbsp;&nbsp;天气查询</a></dd>
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(3,'/OA/page_map','地图查询')">&nbsp;&nbsp;&nbsp;&nbsp;地图查询</a></dd>
			      </dl>
			    </li>
