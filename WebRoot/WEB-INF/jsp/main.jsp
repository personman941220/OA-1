...
<script type="text/javascript">
	$(function(){
		$.getJSON('/OA/getLoginList',function(result){
			for(var i=0;i<result.length;i++){
			$("#loginLogList").append("<tr><td>"+result[i].no+"</td><td>"+result[i].ip+"</td><td>"+result[i].location+"</td><td>"+result[i].createtime+"</td></tr>");
			}
		});//注意小括号和大括号的内外顺序，别写错，一般这种出现的都是})的形式
	});
</script>
